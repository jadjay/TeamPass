...
echo '
                <tr><td>
                    <i class="fa fa-chevron-right mi-grey-1" style="margin-right: .3em;">&nbsp;</i>
                    <label>'.$LANG['comments_system'].'
                        <span style="margin-left:0px;">&nbsp;<i class="fa fa-question-circle tip" title="'.$LANG['comments_system_tip'].'"></i>&nbsp;</span>
                    </label>
                    </td><td>
                        <div class="toggle toggle-modern" id="comments_system" data-toggle-on="', isset($_SESSION['settings']['comments_system']) && $_SESSION['settings']['comments_system'] == 1 ? 'true' : 'false', '"></div><input type="hidden" id="comments_system_input" name="comments_system_input" value="', isset($_SESSION['settings']['comments_system']) && $_SESSION['settings']['comments_system'] == 1 ? '1' : '0', '" />
                </td></tr>';
