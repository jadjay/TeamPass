...
require_once(dirname(__FILE__)."/Exception/BadFormatException.php");
require_once(dirname(__FILE__)."/Exception/CryptoException.php");
require_once(dirname(__FILE__)."/Exception/EnvironmentIsBrokenException.php");
require_once(dirname(__FILE__)."/Exception/IOException.php");
require_once(dirname(__FILE__)."/Exception/WrongKeyOrModifiedCiphertextException.php");
